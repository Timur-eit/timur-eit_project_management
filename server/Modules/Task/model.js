...
exports.removeItem = exports.updateTask = exports.readTaskById = exports.readAllTasksByProjectId = exports.readAllTasks = exports.createTask = exports.sqlSelectTaskListById = exports.sqlSelectProjectByProjectId = void 0;
...
exports.sqlSelectProjectByProjectId = {
    text: 'SELECT id FROM projects WHERE id = $1'
};
exports.sqlSelectTaskListById = {
...
const sqlDeleteItem = { text: 'DELETE FROM tasks WHERE id = $1' };
const createTask = (name, status, type, description, project_id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const columnsCheckerResult = yield utils_1.default(project_id);
    return (columnsCheckerResult ? columnsCheckerResult
        : { statusCode: 200, data: yield database_1.default.query(sqlCreateTask, [name, status, type, description, project_id]) });
});
exports.createTask = createTask;
const readAllTasksByProjectId = (project_id) => __awaiter(void 0, void 0, void 0, function* () {
    const columnsCheckerResult = yield utils_1.default(project_id);
    return (columnsCheckerResult ? columnsCheckerResult
        : { statusCode: 200, data: yield database_1.default.query(sqlSelectTaskListByProjectId, [project_id]) });
});
...
const readTaskById = (id, project_id) => __awaiter(void 0, void 0, void 0, function* () {
    const columnsCheckerResult = yield utils_1.default(project_id, id);
    return (columnsCheckerResult ? columnsCheckerResult
        : { statusCode: 200, data: yield database_1.default.query(exports.sqlSelectTaskListById, [id]) });
});
...
const updateTask = (id, name, description, status, type, project_id) => __awaiter(void 0, void 0, void 0, function* () {
    const columnsCheckerResult = yield utils_1.default(project_id, id);
    return (columnsCheckerResult ? columnsCheckerResult
        : { statusCode: 200, data: yield database_1.default.query(sqlUpdateTask, [name, description, status, type, id]) });
});
exports.updateTask = updateTask;
const removeItem = (id, project_id) => __awaiter(void 0, void 0, void 0, function* () {
    const columnsCheckerResult = yield utils_1.default(project_id, id);
    return (columnsCheckerResult ? columnsCheckerResult
        : { statusCode: 200, data: yield database_1.default.query(sqlDeleteItem, [id]) });
});
